<template>
  <el-table ref="addressTable" v-loading="addressLoading" :data="addressList" :show-header="false" max-height="300px" class="address-table-container" highlight-current-row @row-click="handleClickTableRow">
  ...
  data() {
    return {
      ...
      addressList: [
        ...
        { id: 2, address: '香港 香港 湾仔区 铜锣湾 xxxxx', name: '陈浩南', tel: '(852)2763-0732分機# 7263', phone: '18888882222' },
        ...
        { id: 4, address: '香港 香港 湾仔区 铜锣湾 xxxxx', name: '陈浩南', tel: '(852)2763-0732分機# 7263', phone: '18888882222' },
        { id: 5, address: '香港 香港 湾仔区 铜锣湾 xxxxx', name: '陈浩南', tel: '(852)2763-0732分機# 7263', phone: '18888882222' },
        { id: 6, address: '香港 香港 湾仔区 铜锣湾 xxxxx', name: '陈浩南', tel: '(852)2763-0732分機# 7263', phone: '18888882222' }
      ]
    }
  },
  methods: {
